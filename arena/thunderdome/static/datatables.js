 ...
 *   https://datatables.net/download/#zf-5.5.2/dt-1.10.12/b-1.2.2/cr-1.3.2
 *
 * Included libraries:
 *   Foundation 5.5.2, DataTables 1.10.12, Buttons 1.2.2, ColReorder 1.3.2
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"zf-5.5.2/dt-1.10.12/b-1.2.2/cr-1.3.2",
